  ...
  <nav class="cs-nav">
    ${
      ...
      <a href="case-study.html?project=${nav.prev.slug}" class="cs-nav__item">
        ...
        : '<div class="cs-nav__item" style="pointer-events:none;opacity:0.3;"><span class="cs-nav__dir">←</span><span class="cs-nav__title">—</span></div>'
    }
    ${
      nav.next
        ? /* html */ `
...
function initAnimations() {
  ...
  document
    .querySelectorAll(".cs-challenge, .cs-feature, .cs-metric")
    .forEach((card) => {
      card.addEventListener("mouseenter", () => {
        card.style.transition =
          "background 0.4s, transform 0.4s cubic-bezier(0.165,0.84,0.44,1)";
  ...
  const interactiveEls = document.querySelectorAll(
    "a, button, .cs-challenge, .cs-feature, .cs-decision, .cs-lesson, .cs-nav__item",
  );
