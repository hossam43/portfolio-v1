...
function startHeroAnim() {
  ...
  if (msBadge)
    anim(msBadge, OFFSET + 0, { opacity: "1", transform: "translateY(0)" });
...
(function initLangToggle() {
  ...
  const translations = {
    en: {
      ...
      "h-desc":
        "Building premium digital experiences at the intersection of frontend engineering, geospatial intelligence, and cloud architecture.",
      ...
      "about-p1":
        "Passionate <strong>Frontend Developer</strong> with a deep background in <strong>Geographic Information Systems (GIS)</strong>, I craft seamless, user-centric web experiences that blend technical depth with design precision.",
      "about-p2":
        "Specializing in immersive 3D experiences with Three.js, interactive geospatial visualizations, and enterprise cloud architecture. My work sits at the intersection of design and engineering.",
      ...
      "svc1-desc":
        "Building high-performance, pixel-perfect web applications with modern frameworks. Specializing in complex animations, 3D experiences, and interactive interfaces.",
      "svc2-title": "GIS Solutions",
      "svc2-desc":
        "Transforming complex geospatial data into stunning interactive map experiences. Custom web mapping, spatial analysis, and geospatial application development.",
      "svc3-title": "Cloud Consulting",
      "svc3-desc":
        "Strategic cloud architecture consulting for scalable, resilient applications. From infrastructure design to deployment optimization and performance tuning.",
      // Contact
      "contact-tagline-1": "Ready to",
      "contact-tagline-2": "Start",
      "contact-tagline-3": "Something?",
      "contact-sub":
        "Let's collaborate on your next project. Whether it's a complex web application, a geospatial solution, or cloud architecture.",
      // Nav tooltips
      "nav-home": "Home",
      "nav-about": "About",
      "nav-proj": "Projects",
    ...
    de: {
      ...
      "h-role-3": "Cloud Consultant",
      "h-desc":
        "Premium digitale Erlebnisse an der Schnittstelle von Frontend-Engineering, Geointelligenz und Cloud-Architektur.",
      ...
      "about-p1":
        "Leidenschaftlicher <strong>Frontend-Entwickler</strong> mit umfangreichem Hintergrund in <strong>Geographischen Informationssystemen (GIS)</strong> — ich entwickle nahtlose, nutzerzentrierte Weberlebnisse.",
      "about-p2":
        "Spezialisiert auf immersive 3D-Erlebnisse mit Three.js, interaktive Geovisualisierungen und Cloud-Architektur auf Enterprise-Niveau.",
      ...
      "svc1-desc":
        "Hochleistungsfähige, pixelgenaue Webanwendungen mit modernen Frameworks — spezialisiert auf komplexe Animationen, 3D-Erlebnisse und interaktive Interfaces.",
      "svc2-title": "GIS-Lösungen",
      "svc2-desc":
        "Komplexe Geodaten in beeindruckende interaktive Kartenerlebnisse verwandeln. Individuelle Web-Kartierung, räumliche Analysen und Geoanwendungsentwicklung.",
      "svc3-title": "Cloud Consulting",
      "svc3-desc":
        "Strategische Cloud-Architekturberatung für skalierbare, resiliente Anwendungen — von der Infrastrukturplanung bis zur Deployment-Optimierung.",
      "contact-tagline-1": "Bereit für",
      "contact-tagline-2": "etwas",
      "contact-tagline-3": "Neues?",
      "contact-sub":
        "Lassen Sie uns bei Ihrem nächsten Projekt zusammenarbeiten — ob Web-App, Geolösung oder Cloud-Architektur.",
      "nav-home": "Startseite",
      "nav-about": "Über mich",
      "nav-proj": "Projekte",
      "nav-svc": "Leistungen",
  ...
  function applyLang(lang) {
    ...
    // update toggle UI
    toggle.querySelector(".lang-flag").textContent =
      flagEmoji[lang === "en" ? "de" : "en"]; // show OTHER flag (what you'll switch TO)
...
const PROJECT_SLIDES = {
  "ASL Academy": [
    {
      img: "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=700&q=70&fit=crop",
      label: "Planning Phase",
    },
    {
      img: "https://images.unsplash.com/photo-1488190211105-8b0e65b80b4e?w=700&q=70&fit=crop",
      label: "UI Design",
    },
    {
      img: "https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=700&q=70&fit=crop",
      label: "Development",
    },
  ],
  CryptoPrecision: [
    {
      img: "https://images.unsplash.com/photo-1639762681485-074b7f938ba0?w=700&q=70&fit=crop",
      label: "Concept",
    },
    {
      img: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=700&q=70&fit=crop",
      label: "Design System",
    },
  ],
  Omnifood: [
    {
      img: "https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=700&q=70&fit=crop",
      label: "Planning",
    },
    {
      img: "https://images.unsplash.com/photo-1498837167922-ddd27525d352?w=700&q=70&fit=crop",
      label: "Color System",
    },
    {
      img: "https://images.unsplash.com/photo-1461023058943-07fcbe16d735?w=700&q=70&fit=crop",
      label: "Final Build",
    },
  ],
  "Medicine Market": [
    {
      img: "https://images.unsplash.com/photo-1576091160550-2173dba999ef?w=700&q=70&fit=crop",
      label: "System Design",
    },
    {
      img: "https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?w=700&q=70&fit=crop",
      label: "UI Components",
    },
  ],
  "GIS City Viewer": [
    {
      img: "https://images.unsplash.com/photo-1524661135-423995f22d0b?w=700&q=70&fit=crop",
      label: "Map Architecture",
    },
    {
      img: "https://images.unsplash.com/photo-1477959858617-67f85cf4f1df?w=700&q=70&fit=crop",
      label: "Data Layers",
    },
    {
      img: "https://images.unsplash.com/photo-1529928520614-7877dd3a2f3a?w=700&q=70&fit=crop",
      label: "3D Visualization",
    },
  ],
  "Cloud Dashboard": [
    {
      img: "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=700&q=70&fit=crop",
      label: "Architecture",
    },
    {
      img: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=700&q=70&fit=crop",
...
function buildCarousel(slides) {
  const fallback = [
    {
      img: "https://images.unsplash.com/photo-1537498425277-c283d32ef9db?w=700&q=70&fit=crop",
      label: "Preview",
    },
  ];
...
function initCarousel(container) {
  ...
  container
    .querySelector(".proj-carousel-btn.prev")
    ?.addEventListener("click", (e) => {
      e.stopPropagation();
      goTo(current - 1);
    });
  container
    .querySelector(".proj-carousel-btn.next")
    ?.addEventListener("click", (e) => {
      e.stopPropagation();
      goTo(current + 1);
    });
...
(function buildMainProjectsList() {
  ...
  PROJECTS_DATA.slice(0, 6).forEach((p, i) => {
    ...
    row.innerHTML = `
      <div class="project-row-header" data-idx="${i}">
        ...
        <div class="proj-tags">
          ${p.filters
            .filter((f) => f !== "all")
            .map((f) => `<span class="proj-tag">${f}</span>`)
            .join("")}
        </div>
    ...
    row.querySelector(".project-row-header").addEventListener("click", () => {
      ...
      document
        .querySelectorAll(".project-row-body")
